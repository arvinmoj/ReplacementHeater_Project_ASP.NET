    ...
    public partial class MyFirstMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("bf26d1fb-5bb7-4be5-9f1a-7f9e13612115"), "تهران", null, new Guid("16bcbb89-9dcf-4742-82eb-474013215322"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(440) },
                    { new Guid("30356d4d-3ccc-42c1-b6fa-2db9f0982644"), "اصفهان", null, new Guid("a1d501b1-dbb0-478e-8b54-5aea1497bbfb"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(1430) },
                    { new Guid("fed34815-f8ed-4c58-97bc-7ff4191f6041"), "كرمان", null, new Guid("5b59b32a-ce68-406a-9eef-1390de1fff51"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(1560) }
                });

            migrationBuilder.InsertData(
                table: "Country",
                columns: new[] { "Id", "CountryName", "IdCountry", "InsertDateTime" },
                values: new object[] { new Guid("256d207c-459d-49cd-ad9a-1eb0fd1e5879"), "ایران", new Guid("00bc82fd-6896-4cf2-9180-53b1ed4b2c69"), new DateTime(2021, 6, 10, 23, 14, 37, 724, DateTimeKind.Local).AddTicks(8170) });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("c3682821-16e3-4371-b00a-698495a00fbc"), null, new Guid("597fcc5d-089b-40b2-9acb-f53d49275718"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(4240), "بم" },
                    { new Guid("26be0505-3e7f-482a-bb55-d70224894264"), null, new Guid("86b7d42b-4518-4b77-a261-a5f39bb55ebc"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(5170), "ايمانشهر" },
                    { new Guid("9f9400ca-8708-46b0-ad35-c9db9dd77ed7"), null, new Guid("b3161d5a-9416-4820-a1c6-a3f6d44c7036"), new DateTime(2021, 6, 10, 23, 14, 37, 731, DateTimeKind.Local).AddTicks(5200), "البرز" }
                });
